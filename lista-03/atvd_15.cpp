...
int main() {
  ...
  const string words[MAX_WORDS] = {
    "peixe", "conhecimento", "livro", "advogado", "apartamento",
    "bicicleta", "lagosta", "semente", "congelar", "faculdade",
  };
  ...
  while(errors < MAX_ERRORS) {
    ...
    if(repeated){
      cout << "- Esta letra já foi utilizada." << endl << endl;
      repeated = false;
    }
    cout << "Palavra: " << endl;
    ...
    if (correctsWords == lenWord) break;
  }
  ...
  if(errors == MAX_ERRORS){
    cout << endl << endl << "Você morreu! A palavra correta era: \"" << randomWord << "\"." << endl;
  } else {
    cout << endl << endl << "Você ganhou!!! Palavra descoberta: \"" << randomWord << "\"." << endl;
